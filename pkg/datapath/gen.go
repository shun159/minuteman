...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target amd64 -cc clang -cflags "-O2 -g -Wall -Wno-compare-distinct-pointer-types" -type b4_config -type lan_config -type fanout_config bpf ../../bpf/datapath.bpf.c -- -I../../bpf
